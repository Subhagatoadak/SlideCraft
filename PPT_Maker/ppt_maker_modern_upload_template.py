...
st.sidebar.info(
    ...
    "3. Optionally add background images for title, sections, and slides.\n"
    "4. You can manually create sections and slides or auto-generate slides using AI.\n"
    "5. For manual slides, add rich content with custom fonts, images, charts, and improvement tips.\n"
    "6. When using foreground images, you can upload multiple images.\n\n"
...
def create_presentation(presentation_title, description, author, template_file,
                        title_bg_bytes, common_content_bg_bytes, sections_data):
    # Use the uploaded template if provided.
...
def main():
    ...
    if st.button("Generate PPT"):
        ...
        ppt_file = create_presentation(presentation_title, description, author,
                                       ppt_template, title_bg_bytes, common_content_bg_bytes,
                                       sections_data)
